...
public class GeneralTreeTestDriver {
	public static void main(String[] args) {
		...
		// Leaves
		GeneralTreeInterface<String> brianTree = new CompletedGeneralTree<>("Brian");
		GeneralTreeInterface<String> susanTree = new CompletedGeneralTree<>("Susan");
		GeneralTreeInterface<String> jaredTree = new CompletedGeneralTree<>("Jared");
		GeneralTreeInterface<String> jamieTree = new CompletedGeneralTree<>("Jamie");

		// Subtrees:
		// The casts are safe because the new arrays contains null entries
		@SuppressWarnings("unchecked")
		GeneralTreeInterface<String>[] brettChildren = new CompletedGeneralTree[2];
		brettChildren[0] = susanTree;
		brettChildren[1] = null;
		GeneralTreeInterface<String> brettTree = new CompletedGeneralTree<>();
		brettTree.setTree("Brett", brettChildren);

		@SuppressWarnings("unchecked")
		GeneralTreeInterface<String>[] jenniferChildren = new CompletedGeneralTree[2];
		jenniferChildren[0] = jaredTree;
		jenniferChildren[1] = jamieTree;
		GeneralTreeInterface<String> jenniferTree = new CompletedGeneralTree<>();
		jenniferTree.setTree("Jennifer", jenniferChildren);

		@SuppressWarnings("unchecked")
		GeneralTreeInterface<String>[] caroleChildren = new CompletedGeneralTree[3];
		caroleChildren[0] = brettTree;
		caroleChildren[1] = jenniferTree;
		caroleChildren[2] = brianTree;
		GeneralTreeInterface<String> caroleTree = new CompletedGeneralTree<>();
	...
	public static void testEmptyTree() {
		System.out.println("\nTest empty tree:");
		GeneralTreeInterface<String> myTree = new CompletedGeneralTree<>();
