 ...
 * @author mhrybyk
 * 
 * This tests Bag.java in the textbook. Renamed to be more descriptive.
 * Same basic tests as BagDemo.java
 */
public class ResizableArrayBagDemo {
	public static void main(String[] args) {
		// A bag whose initial capacity is small
//		BagInterface<String> aBag = new CompletedResizableArrayBag<>(3);
		BagInterface<String> aBag = new ResizableArrayBag<>(3);
		testIsEmpty(aBag, true);

		System.out.println("Adding to the bag more strings than its initial capacity of 3.");
...
Adding to the bag more strings than its initial capacity of 3.
