...
//		ListInterface<String> myList = new CompletedListUsingLibraryLinkedList<>();
//		ListInterface<String> myList = new AList<>();
//		ListInterface<String> myList = new LList<>();
//		ListInterface<String> myList = new LListWithTail<>();
//		ListInterface<String> myList = new ListUsingLibraryLinkedList<>();
...
//		myList = new CompletedListUsingLibraryLinkedList<>();
//		myList = new AList<>();
//		myList = new LList<>();
//		myList = new LListWithTail<>();
//		myList = new ListUsingLibraryLinkedList<>();
